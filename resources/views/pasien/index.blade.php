...
@section('content')
    @php
        $no = 0;
    @endphp
    <div class="main" style="background-color: rgb(115, 218, 87);">
        <style>
            td {
                color: #000000;
            }
        ...
        <div class="main-content"
            style=" height: 1000%; width: 200; background-color: rgb(115, 218, 87); background-size: cover; background-position: center; ">
            <div class="panel-heading" style="">
                <h1 class="panel-title" style="color: white; font-size: 4ch; padding-bottom: 4%; padding-top: 0px">
                    Rumah-Sakit {{ $users }}</h1>
            </div>
            <div class="container-fluid" style="color: rgb(115, 218, 87); ">
                <div class="row">
                    <div class="col-md-12">
                        <!-- TABLE HOVER -->
                        <div class="panel" style="  background-color: rgba(255, 255, 255, 0.7);">
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 20px">
                                <div style="width: 100%; padding-left: 40px ">
                                    <h4>Total Data = {{ $jumlah_pasien }} </h4>
                                </div>
                                <div style="width: 100%; padding-top: 20px; padding-left: 120px">
                                    <button type="button" class="btn btn-"
                                        style="background-color: rgb(115, 218, 87); color: white" data-toggle="modal"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/pasien/{{ $pasien->id }}/edit" class="btn btn- btn-sm"
                                                        style="background-color:  rgb(115, 218, 87); color: white">Edit
                                                    </a>
                                                    <a href="/pasien/{{ $pasien->id }}/delete" class="btn btn- btn-sm"
                                                        style="background-color: rgb(115, 218, 87); color: white"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                    style="background-color: rgb(115, 218, 87); ">Simpan</button>
                                            </div>
                                            </form>
                                        </div>
